...
public class HardGridWorldLauncher {
	...
	public static void main(String[] args) {
		...
		BasicGridWorld gen = new BasicGridWorld(map,24,24); //0 index map is 25x25
		Domain domain = gen.generateDomain();

		State initialState = BasicGridWorld.getExampleState(domain);

		RewardFunction rf = new BasicRewardFunction(24, 24); //Goal is at the top right grid
		TerminalFunction tf = new BasicTerminalFunction(24, 24); //Goal is at the top right grid
